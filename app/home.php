    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-8" style="border-radius:5px; background:white; padding-bottom:40px">
                <h2>What We Do</h2>
                <p>Fresh Car Washing shop is focus on dedicated to solving auto beauty, car maintenance and maintenance.</p>
                <p>For now in CDUT DongYuan region we have collected more than 300 members. We will take good care of your car; make your car keep optimum state.</p>             
            </div>
            <div class="col-sm-3" style="border-radius:5px; background:white; padding-bottom:20px; margin-left:30px">
                <h2>Contact Us</h2>
                <address>
                    <strong>Fresh Car Washing Shop</strong>
                    <br>3481 Melrose Place
                    <br>Chengdu city Chenghua District road Erxian Qiaodong 
                    <br>
                </address>
                <address>
                    <abbr title="Phone">P:</abbr>(+86) 155-2815-3691
                    <br>
                    <abbr title="Email">E:</abbr> <a href="mailto:#">Tiankaiyuan@bibijz.com </a>
                </address>
            </div>
        </div>
        <!-- /.row -->
